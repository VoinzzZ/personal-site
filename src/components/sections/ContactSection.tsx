...
export default function ContactSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="flex flex-col items-center justify-center min-h-[40vh] sm:min-h-[50vh] py-20 sm:py-24 px-4 scroll-mt-20"
    >
      <div className="w-full max-w-5xl mx-auto relative">
        ...
        <div className="flex flex-col items-center gap-4 font-mono text-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <a
              ...
              className="group w-full sm:w-64 px-6 py-3 bg-transparent border border-cyan-400 text-cyan-300 font-semibold hover:bg-cyan-400 transition-colors rounded-none text-center"
            >
          ...
          <a
            ...
            className="group w-full sm:w-64 px-6 py-3 bg-transparent border border-purple-400 text-purple-300 font-semibold hover:bg-purple-400 transition-colors rounded-none text-center"
          >
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group px-3 py-2 sm:px-4 sm:py-3 bg-[#1a1a1a] border border-white/10 rounded-lg flex items-center gap-3 text-gray-400 hover:border-cyan-400/50 hover:text-cyan-400 transition-all"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group px-3 py-2 sm:px-4 sm:py-3 bg-[#1a1a1a] border border-white/10 rounded-lg flex items-center gap-3 text-gray-400 hover:border-purple-400/50 hover:text-purple-400 transition-all"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 shrink-0">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group px-3 py-2 sm:px-4 sm:py-3 bg-[#1a1a1a] border border-white/10 rounded-lg flex items-center gap-3 text-gray-400 hover:border-green-400/50 hover:text-green-400 transition-all"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 shrink-0">
