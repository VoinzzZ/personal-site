      ...
      <div className="w-full max-w-5xl mx-auto relative">
        ...
        <div className="flex flex-row items-center justify-center gap-4 mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-16 h-16 bg-[#1a1a1a] border border-white/10 rounded-lg flex items-center justify-center text-2xl text-gray-400 hover:border-cyan-400/50 hover:text-cyan-400 hover:shadow-[0_0_20px_-5px_#22d3ee] transition-all"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-16 h-16 bg-[#1a1a1a] border border-white/10 rounded-lg flex items-center justify-center text-2xl text-gray-400 hover:border-purple-400/50 hover:text-purple-400 hover:shadow-[0_0_20px_-5px_#a855f7] transition-all"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-16 h-16 bg-[#1a1a1a] border border-white/10 rounded-lg flex items-center justify-center text-2xl text-gray-400 hover:border-green-400/50 hover:text-green-400 hover:shadow-[0_0_20px_-5px_#4ade80] transition-all"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
