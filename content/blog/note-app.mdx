...
## Screenshots
![Note App login screen](/images/note-app-login.webp)
![Notes dashboard with search, tags, and pinning](/images/note-app-2.webp)
![Note editor modal and tag management](/images/note-app-3.webp)
